...
<body class="backdrop-brightness-30"
    ...
    <div class="">
        ...
        <div class="flex flex-col justify-center items-center min-h-screen relative z-0">
            ...
            <form action="/login" method="POST" class="flex flex-col justify-center items-center space-y-8 m-3 w-full max-w-xs">
                @csrf
                <div class="flex flex-col justify-center items-center space-y-2 w-full">
                    ...
                    <input type="password" placeholder="Password" name="password" class=" rounded p-2 w-full bg-white" required>
                </div>
