                ...
                <table id="transactionTable" class="min-w-full divide-y divide-gray-200 table-fixed">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="show" data-id="{{ $transaction->id }}">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $transaction->expedition_id ?? 'Biteship'; }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $transaction }}</td>
