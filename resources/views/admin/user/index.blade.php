        ...
        <div class="mt-6 flex gap-6 items-start">
                    ...
                    <table id="userTable" class="min-w-full divide-y divide-gray-200 table-fixed">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($users as $user)
                                <tr class="show" data-id="{{ $user->id }}" data-name="{{ strtolower($user->name) }}"
                                    data-email="{{ strtolower($user->email) }}" data-role="{{ strtolower($user->role) }}"
                                    data-phone="{{ strtolower($user->phone) }}" data-address="{{ strtolower($user->address) }}"
                                    data-resto="{{ strtolower($user->resto_name) }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                        ...
                                        <form action="{{ url('/admin/category', $user->id) }}" method="POST" class="inline"
            ...
            <script>
                document.getElementById('searchUser').addEventListener('input', function () {
                    ...
                    document.querySelectorAll('#userTable tbody tr.show').forEach(row => {
                    ...
                    // sembunyikan semua edit row
                    document.querySelectorAll('#userTable tbody tr.edit').forEach(row => {
                        row.style.display = 'none';
                    });
